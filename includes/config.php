...
define( 'YOURLS_DB_USER', '454260_4cto' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', '8KcvYoKEcQ8Ggj' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', '454260_4cto' );

/** MySQL hostname */
define( 'YOURLS_DB_HOST', 'mysql50-77.wc2.dfw1.stabletransit.com' );
...
$yourls_user_passwords = array(
	'matt' => 'SdaZqY7JpTPtl4mr',
	'ben' => 'tmnt1',
	'lee' => 'tmnt1'	// You can have one or more 'login'=>'password' lines
	);
